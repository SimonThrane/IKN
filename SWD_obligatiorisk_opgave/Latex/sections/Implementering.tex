...
\noindent Som det ses ovenfor skal chainen sættes manuelt op i clienten. Handler 1 skal således kaldes for at være sikker på at alle led i kæden bliver travaseret. 

\noindent Det fulde klassediagram, ses på figur \ref{fig:KonkretKlassediagram}. Det kan ses det ligner den gennerelle beskrivelse meget.
